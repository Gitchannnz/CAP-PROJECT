                    ...
                    <div class="accordion-item mb-4">
                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                            ...
                            <input class="price-range-slider" type="text" name="price_range" value=""
                                data-slider-min="10" data-slider-max="2000" data-slider-step="10"
                            ...
                            <div class="slide-split_text position-relative d-flex align-items-center" style="background-color: #042444;">
                                <div class="slideshow-text container p-3 p-xl-5">
                                    <h2 class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2" style="color: white;">
                                        IGP <br /><strong>PRODUCT</strong></h2>
                                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5" style="color: white;">Refresh your style effortlessly with IGP Product. Embrace the latest trends or invest in enduring favorites that never go out of fashion.</p>
                                </div>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                            <div class="slide-split_text position-relative d-flex align-items-center" style="background-color: #042444;">
                                <div class="slideshow-text container p-3 p-xl-5">
                                    <h2 class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2" style="color: white;">
                                        BUY <br /><strong>NOW</strong></h2>
                                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5" style="color: white;">Buying made easy with IGP Product. Quality selections that inspire confidence in every purchase.</p>
                                </div>
                            </div>
                            <div class="slide-split_media position-relative">
                                <div class="slideshow-bg" style="background-color: #042444;">
                ...
                <div class="swiper-slide">
                    <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                        <div class="slide-split_text position-relative d-flex align-items-center" style="background-color: #042444;">
                            <div class="slideshow-text container p-3 p-xl-5">
                                <h2 class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2" style="color: white;">
                                    SHOP <br /><strong>NOW</strong>
                                </h2>
                                <span class="mb-0 animate animate_fade animate_btt animate_delay-5" style="color: white;">
                                    Shopping made seamless with IGP Product. Discover what you love in just a click!
                                </span>
                            </div>
                        </div>
                        <div class="slide-split_media position-relative">
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    @if (Cart::instance('wishlist')->content()->where('id', $product->id)->count() > 0)
                                        <form method="POST"
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                class="pc__btn-wl position-absolute top-0 end-0 bg-transparent border-0 js-add-wishlist filled-heart title="
