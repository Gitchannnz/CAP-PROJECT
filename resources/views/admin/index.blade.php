                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4>{{ $dashboardDatas[0]->TotalPending }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4>{{ $dashboardDatas[0]->TotalPendingAmount }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="wg-box">
                    ...
                    <div class="flex flex-wrap gap40">
                        ...
                        <div>
                            <div class="mb-2">
                                <div class="block-legend">
                                    <div class="dot t2" style="background-color: #FFA500 !important;"></div>
                                    <div class="text-tiny">Pending</div>
                                </div>
                            </div>
                            <div class="flex items-center gap10">
                                <h4>₱{{ $TotalPendingAmount }}</h4>
                            </div>
                        </div>
                        <div>
                            <div class="mb-2">
                                <div class="block-legend">
                                    <div class="dot t2" style="background-color: #078407 !important;"></div>
