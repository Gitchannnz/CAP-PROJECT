            ...
            <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data"
                ...
                <div class="wg-box">
                    ...
                    <fieldset class="description">
                        ...
                        <div class="text-tiny">Do not exceed 1000 characters when entering the description.</div>
                    </fieldset>
                    @error('description')
                        <span class="alert alert-danger text-center">{{ $message }}</span>
                    @enderror
                ...
                <div class="wg-box">
                    ...
                    <div class="cols gap22">
                        ...
                        <fieldset class="name">
                            <div class="body-title mb-10">Quantity in stock <span class="tf-color-1">*</span></div>
                        ...
                        @enderror
                        <fieldset class="name">
                            <div class="body-title mb-10">Critical Level <span class="tf-color-1">*</span></div>
                            <input class="mb-10" type="text" placeholder="Enter critical level"
                                name="critical_level" tabindex="0" value="{{ old('critical_level') }}"
