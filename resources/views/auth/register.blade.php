                    ...
                    <div class="register-form">
                        <form method="POST" action="{{ route('register') }}" name="register-form" class="needs-validation"
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input id="firstname" type="text"
                                            class="form-control form-control_gray @error('firstname') is-invalid @enderror"
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input id="middlename" type="text"
                                            class="form-control form-control_gray @error('middlename') is-invalid @enderror"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input id="lastname" type="text"
                                            class="form-control form-control_gray @error('lastname') is-invalid @enderror"
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input id="institutional_id" type="text"
                                            class="form-control form-control_gray @error('institutional_id') is-invalid @enderror"
                                            name="institutional_id" value="{{ old('institutional_id') }}"
                                            autocomplete="institutional_id">
